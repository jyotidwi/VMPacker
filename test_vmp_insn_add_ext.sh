#!/bin/bash
# test_vmp_insn_add_ext.sh
# T4: ADD/SUB extended register 自动化测试脚本
# 用法: bash test_vmp_insn_add_ext.sh
set -e

DEMO=demo_insn_add_ext
FUNC=test_add_ext
BUILD=build
DEVICE_DIR=/home/root/vmp

echo "=== T4: ADD/SUB extended register 自动化测试 ==="
...
echo ""
echo "=== T4: ADD/SUB extended register 全部测试通过 ✅ ==="
